...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton notify = findViewById(R.id.notification);
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
            ...
            public void onComplete(@NonNull Task<InstanceIdResult> task) {
                ...
                // Log and toast
                Log.d(TAG, TOKEN);
                Toast.makeText(VideoActivity.this, TOKEN, Toast.LENGTH_SHORT).show();
            }
        });
        notify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FcmNotifier.sendNotification("hi", "hieeeeeee", "oye");
            }
        });
        /*
    ...
    private void createAudioAndVideoTracks() {
        ...
        localVideoTrack = LocalVideoTrack.create(this,
                true,
                cameraCapturerCompat.getVideoCapturer(), LOCAL_VIDEO_TRACK_NAME);
    ...
    private void sendNotification(String roomName){
        FcmNotifier.sendNotification("Hello World!", "Abdullah Calling...", roomName);
    }
    ...
    private void showConnectDialog() {
        ...
        connectDialog = Dialog.createConnectDialog(roomEditText, connectClickListener(roomEditText),
                cancelConnectDialogClickListener(),this);
        connectDialog.show();
    }
    ...
    private void retrieveAccessTokenfromServer() {
        String finalURL = String.format("%s%s", ACCESS_TOKEN_SERVER,
